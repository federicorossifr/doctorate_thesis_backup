...
\title{Innovative arithmetics for efficient DNN computing:
HW and SW solutions and their integration in RISC-V platforms}
\tutor{William FORNACIARI, Leonel SOUSA}
\supervisor{Marco COCOCCIONI, Sergio SAPONARA}
