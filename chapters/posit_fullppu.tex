\chapter{Full Posit Processing Unit (FPPU)}\label{chap:posit_fullppu}
...
%let's consider the RTL schematic in Figure \ref{fig:lzc_sinthesyzed} for a 16-bit leading zero counter.
...
\centering
    \begin{minipage}{0.5\linewidth}
        ...
        \includegraphics[
            %scale=1
            width=0.67\linewidth]{figures/lod2_11.png}
